...
extern class React {
	...
	**/
	...
	/**
		...
		to use `defaultValue`.
	**/
	public static function createContext<TContext>(?defaultValue:TContext, ?calculateChangedBits:TContext->TContext->Int):ReactContext<TContext>;
	...
	**/
	...
	public static function useCallback(callback:Void->Dynamic, data_dependencies:Array<Dynamic>):Array<ReactFragment>;

	/**
		https://reactjs.org/docs/hooks-reference.html#usememo
	**/
	public static function useMemo(callback:Void->Dynamic, data_dependencies:Array<Dynamic>):Array<ReactFragment>;
}
